...
# (Removed) legacy toggles: disable_audio, disable_exporters
...
# No exporter/audio feature macros; keep symbols to avoid link issues.
...
# Keep modules list intact; slimming can be done via module_*_enabled flags.
