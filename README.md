...
| 策略 | 模块 | 方式 | 预计减少 | 状态 |
|------|------|------|---------|------|
| **宏控制** | 音频系统 | 编译宏包裹 | ~20MB（可选） | 📋 计划中 |
| **宏控制** | 扩展图像格式 | 编译宏包裹 | ~15MB（可选） | 📋 计划中 |
| **直接删除** | 网络系统 | 删除源码 | ~33MB | ✅ 已完成 |
| **直接删除** | 导航系统 | 删除源码 | ~13MB | ✅ 已完成 |
| **直接删除** | 其他工具 | 删除源码 | ~8MB | ✅ 已完成 |

**已完成**: 网络/导航/3D工具模块代码已删除（约7.7MB），第三方依赖待清理（约10.8MB）
**进行中**: 文档更新和中文注释
**计划中**: 音频和图像格式的宏控制框架
